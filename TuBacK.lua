...
local Text = ' ⌔︙المستخدم » '..Name..'\n✅| تم حظره في المجموعة من التواصل'
...
local Name = '['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
local Text = ' ⌔︙المستخدم » '..Name..'\n✅| تم الغاء حظره في المجموعة من التواصل'
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
...
function(arg,data) 
usertext = '\n🚹꒐ العضو :  ['..data.first_name_..'](t.me/'..(data.username_ or 'TuBakx')..')'
status  = '\n✅| تم حظره في المجموعة عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌔︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TuBakx')..')'
status  = '\n ⌔︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n🚹꒐ العضو :  '..userid..''
