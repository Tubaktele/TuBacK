...
if TuBacK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X04XX')..') \n ⌔︙'..TuBacK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⌔︙العضو : {["..data.first_name_.."](T.ME/X04XX)}\n ⌔︙["..TuBacK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌔︙عذرا » {["..data.first_name_.."](T.ME/X04XX)}\n ⌔︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌔︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'X04XX')..') \n ⌔︙تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌔︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'X04XX')..')'
status  = '\n ⌔︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌔︙العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌔︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'X04XX')..')'..'\n ⌔︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."X04XX:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."X04XX:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."X04XX:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."X04XX:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."X04XX:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."X04XX:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
numj = {"جلب 🦮","مطي 🐴","بقرة 🐄","ثور 🐂","فأر 🐀","قنفذ 🐿","كلب الماي 🦭"جلب 🦮",};
sendnuj = numj[math.random(#numj)]
xl = '⌔︙*اليك النتائج الخاصة بـ ❲ '..text..' ❳ 🔽 : * '..sendnuj..'\n\n⌔︙*نسبة الحيوان -* '..sendnuj..'%'
send(msg.chat_id_, msg.id_,xl) 
